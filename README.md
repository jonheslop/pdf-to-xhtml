...
pdf-to-xhtml convert /path/to/book.pdf --out book.xhtml --body 10 --map 24=h1:chapter-heading --map 15=h2 --map 12.5=h3 --drop-below 9 --min-image-size 100 --small-caps-pattern '\b[A-Z]{4,}\b'
